...
document.addEventListener('DOMContentLoaded', function () {
  ...
  ContextMenu.prototype.show = function (evt) {
    evt.preventDefault();
    var menuNode = document.querySelector('.contextmenu');
  ...
  ContextMenu.prototype.coodrs = function (evt) {
    ...
    var coords = function coords(elm) {
  ...
  ContextMenu.prototype.listener = function () {
    var menu = ContextMenu.prototype.show;
    var menuCoords = ContextMenu.prototype.coodrs;
